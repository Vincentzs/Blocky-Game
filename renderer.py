...
def _print_to_image(text: str, x: int, y: int, font: pygame.font.Font,
    ...
    """Use <font> to print <text> to (<row>, <col>) on <image> with <colour>.
    """
...
class Renderer:
    ...
    # _status_position:
    #   The (row, col) position of the status messages.
    ...
    def __init__(self, size: int) -> None:
        """Initialize this Renderer for a board with dimensions <size> row <size>.
        """
    ...
    def print(self, text: str, x: int, y: int) -> None:
        """Print <text> to the (<row>, <col>) location on the screen.
        """
